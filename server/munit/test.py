...
parser.add_argument('--config', type=str, default='configs/syn2city_folder.yaml', help="net configuration")
...
#opts.input_folder = '/data/gezi/dataset/day2night/trainA'
opts.input_folder = '/home/lyc/data/ll/dataset/syn2city/test/A'

opts.output_folder = 'munit-city2syn/'
